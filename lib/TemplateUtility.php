...
class TemplateUtility
{
    ...
    public static function printHeaderBlock($showTopRight = true)
    {
        ...
        /* CATS Logo */
        echo '<table cellspacing="0" cellpadding="0" style="margin: -3px 0px 0px 0px; padding: 10px 10px 10px 0px; float: left;">', "\n";
        echo '<tr>', "\n";
        echo '<td rowspan="2"><!--<span style="color:#99d903; font-size:48px; font-weight:bold;">HRT</span><span style="color:#606060; font-size:40px; font-weight:bold;">racking</span><br><h5 style="font-size:14px; font-weight:bold; padding:0px; margin:9px 2px 0 0; color:#606060;">Applicant Tracking System</h5>--><img src="images/applicationLogo.png" width="235px" height="82px" border="0" alt="HRTRACKING Applicant Tracking System" /></td>', "\n";
        echo '</tr>', "\n";
        echo '</table>', "\n";

    ...
    <div id="main">
        ...
        <div id="contents">
            ...
            <table width="100%">
                <tr>
                    <td width="100%">
                        <p class="noteUnsized">HRTracking Professional</p>
                        ...
                        <?php if (!file_exists('modules/asp')): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    Downloads that extend HRTracking to make recruiting easy.
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <br />
                                    To renew or add user licenses, log in to the HRTracking Professional website, <a href="http://www.catsone.com/professional" target="_blank">http://www.catsone.com/<b>professional</b></a>.
                                    <?php else: ?>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                <td colspan="2" style="background: #E7EFFF no-repeat; height: 50px; color: #6C92E3;">
                                    <span style="font-size: 28px; font-weight: bold;"> HRTracking Professional: Links & Resources </span> &nbsp;
                                </td>
                            </tr>
                        ...
                        <?php if ($this->systemAdministration): ?>
                            ...
                            <table class="searchTable" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Change how HRTracking stores user passwords, and how users can retrieve them.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="230">
                                    ...
                                    <td>
                                        Change how HRTracking checks periodically for new versions.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="230">
                                    ...
                                    <td>
                                        View information about this HRTracking installation.
                                    </td>
                                </tr>
                            </table>
                        <?php endif; ?>

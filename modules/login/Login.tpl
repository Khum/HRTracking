...
<html>
    ...
    <?php TemplateUtility::printPopupContainer(); ?>
        <div id="headerBlock">
            <span id="mainLogo">H&nbsp;R&nbsp;T&nbsp;R&nbsp;A&nbsp;C&nbsp;K&nbsp;I&nbsp;N&nbsp;G</span><br />
            ...
            <div id="login">
                ...
                <div id="loginText">
                    <div class="ctr">
                        ...
                        <img src="images/applicationLogo.png" width="177" height="82" alt="security" />
                    </div>
                    <br />
                    <span>Welcome to HRTracking!</span><br />
                    <span style="font-size: 10px;"> <?php //echo(CATSUtility::getVersion()); ?></span>

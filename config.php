...
define('DATABASE_USER', 'besttou1_man');
define('DATABASE_PASS', 'bfBdglJguna3');
define('DATABASE_HOST', 'localhost');
define('DATABASE_NAME', 'besttou1_cats');
 ...
 */
define('CAREERS_OWNERAPPLY_SUBJECT', 'HALCROW - A Candidate Has Applied to Your Job Order');
 ...
 */
define('FORGOT_PASSWORD_FROM_NAME', 'HALCROW');
define('FORGOT_PASSWORD_SUBJECT',   'HALCROW - Password Retrieval Request');
define('FORGOT_PASSWORD_BODY',      'You recently requested that your HALCROW: Applicant Tracking System password be sent to you. Your current password is %s.');
...
This is a reminder from the HALCROW Applicant Tracking System about an
upcoming event.
...
--
HALCROW Applicant Tracking System
EOF;
